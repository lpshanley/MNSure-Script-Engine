...
var _styles = $('<link>', {href: chrome.extension.getURL('css/appStyles.css'), rel: 'stylesheet', type: 'text/css' });
$( 'head' ).append( _styles );

var _jquery = $('<script>',{ 'src': 'https://code.jquery.com/jquery-1.12.4.min.js' });
$( 'head' ).append( _jquery );

var _app = $('<script>',{ 'src': chrome.extension.getURL( 'js/app.js' ), 'data-chromeURL': chrome.extension.getURL(''), 'data-ScriptEngine': '', 'data-extensionID': chrome.runtime.id });
$( 'head' ).append( _app );
