...
var _styles = $('<link>', {href: 'https://github.com/lpshanley/MNSure-Script-Engine/blob/master/css/appStyles.css', rel: 'stylesheet', type: 'text/css' });
$( 'head' ).append( _styles );

var _jquery = $('<script>',{ 'src': 'https://code.jquery.com/jquery-1.12.4.min.js' });
$( 'head' ).append( _jquery );

var _app = $('<script>',{ 'src': 'https://raw.githubusercontent.com/lpshanley/MNSure-Script-Engine/master/js/app.js', 'data-chromeURL': chrome.extension.getURL(''), 'data-ScriptEngine': '', 'data-extensionID': chrome.runtime.id });
$( 'head' ).append( _app );
