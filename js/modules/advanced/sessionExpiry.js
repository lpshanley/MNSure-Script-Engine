...
_engine.module.define('advanced/sessionExpiry',function( log ){
	...
	if( log ) _engine.debug.info(`[advanced/sessionExpiry] Timeout data: Session expiry ${ sessExp.toLocaleTimeString() } | Server last action ${ servExp.toLocaleTimeString() }`);
