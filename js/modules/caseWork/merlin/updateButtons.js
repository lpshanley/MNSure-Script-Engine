...
_engine.module.define('caseWork/merlin/updateButtons',function( id, buttonConfig ){
	...
	let addButton = function( key, req ){
		...
		if(typeof req === 'string'){
			switch( req.toLowerCase() ){
				case 'submit':
					props.label = 'Submit';
					props.onclick = "_engine.events.handleClickEvent('ui.modal.button(submit)')";
					props.role = 'submit';
					break;
				case 'close':
					props.label = 'Close';
					props.onclick = "_engine.events.handleClickEvent('ui.modal.button(close)')";
					props.role = 'exit';
					break;
				default:
					break;
