...
_engine.module.define('tools/customApi/evidence/evidenceQueryUrlConstructor',function( type, callback ){
	...
	let root = "en_US/Evidence_workspaceTypeListPage.do?",
			...
			queryDefinition = _engine.advanced.vars.queryDefinitions,
			objReturn = false,
